...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_ts_page_2Fsrc_2Fmiddleware_rootDir_C_3A_5CUsers_5CUser_5CDemo_20Apps_20For_20My_20Official_20Website_5CGood_20Website_20Models_5Cchatappbydeo_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
/* harmony default export */ const src_middleware = ((0,middleware.withAuth)(async function middleware(req) {
    ...
    const isAuth = await (0,jwt.getToken)({
        req
    });
    ...
    if (isLoginPage) {
        if (isAuth) {
            return spec_extension_response/* NextResponse */.x.redirect(new URL("/dashboard", req.url));
        }
        return spec_extension_response/* NextResponse */.x.next();
    }
    if (!isAuth && isAccessingSensitiveRoute) {
        return spec_extension_response/* NextResponse */.x.redirect(new URL("/login", req.url));
    }
    if (pathname === "/") {
        return spec_extension_response/* NextResponse */.x.redirect(new URL("/dashboard", req.url));
    }
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=C%3A%5CUsers%5CUser%5CDemo%20Apps%20For%20My%20Official%20Website%5CGood%20Website%20Models%5Cchatappbydeo&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_ts_page_2Fsrc_2Fmiddleware_rootDir_C_3A_5CUsers_5CUser_5CDemo_20Apps_20For_20My_20Official_20Website_5CGood_20Website_20Models_5Cchatappbydeo_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/src/middleware",
            handler,
...
var _jose = __webpack_require__(967);
